    ...
    <section className="bg-[#050510] py-20 px-6">
      <div className="max-w-[1120px] mx-auto flex flex-col gap-10">
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
          ...
          <SlideUp delay={0.15}>
            <p className="text-white/50 text-[15px] font-sans leading-[22px] tracking-[-0.2px] max-w-[400px]">
                ...
                experiences.slice(0, 3).map((item, i) => (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <span
                        className={`${item.tagColor} text-white text-[12px] font-sans font-medium px-3 py-1 rounded-full`}
                      >
                        {item.tag}
                      </span>
                    </div>
                    <div className="flex flex-col gap-2 flex-1">
                      <h4 className="text-white text-[19px] font-sans font-medium leading-[26px]">
                        {item.title}
                      </h4>
