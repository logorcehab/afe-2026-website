...
import svgPaths from "@/components/figma/svg-5qho7fhee1";
import { SlideUp } from "@/components/ui/SlideUp";
import Image from "next/image";

const imgWhoAttends = "/assets/fb933dc162db17f0059b5014d667b680bc3baba6.png";
    ...
    <SlideUp delay={delay}>
      <div className="flex flex-col gap-5 pb-5 relative">
        ...
        <div className="flex flex-col gap-1">
          <h4 className="font-sans font-medium text-white text-[22px] tracking-[-0.5px] leading-[34px]">
            {attendee.title}
          </h4>
          <p className="font-sans text-white/50 text-[15px] tracking-[-0.2px] leading-[22px]">
            {attendee.desc}
          </p>
        </div>
    ...
    <section id="who-attends" className="bg-[#0e0e1c] py-20 px-6">
      <div className="max-w-[1120px] mx-auto flex flex-col gap-[60px]">
        ...
        <div className="flex flex-col gap-[10px] items-center text-center">
          <SlideUp>
            <span className="text-[#e30071] text-[15px] font-sans tracking-[-0.2px] leading-[22px]">
              Who attends
            </span>
          </SlideUp>
          <SlideUp delay={0.1}>
            <h2 className="font-sans font-semibold text-white text-[40px] md:text-[58px] leading-[1.15] tracking-[-3px]">
