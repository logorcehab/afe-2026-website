...
const imgRegion1 = "/assets/c93465f8b947f83f01e13958fa9fd4ce73435396.png";
const imgRegion2 = "/assets/55d220000469b2d3c0fee3f8a3dde19765ea4990.png";
const imgRegion3 = "/assets/fc16b2e4b54e0198e044ac1b1b089977d3ca51e9.png";
const imgRegion4 = "/assets/3ec4feeff151e204122381b626f147d6eaa21fb5.png";
...
function ParallaxImage({ src, alt, accent, number, scrollYProgress }: { src: string; alt: string; accent: string; number: string; scrollYProgress: any }) {
  ...
  return (
    <div className="absolute inset-0 overflow-hidden">
      ...
      {/* Large number */}
      <p className="absolute top-3 right-6 font-sans font-bold text-[100px] lg:text-[120px] leading-none text-white/[0.06] select-none">
        {number}
      </p>
    </div>
  );
...
function RegionCard({
  ...
  const textBlock = (
    <div className="flex flex-col justify-center px-8 lg:px-14 py-12 lg:py-16">
      ...
      <SlideUp delay={0.15}>
        <h3 className="font-sans font-bold text-white text-[32px] lg:text-[42px] leading-[1.1] tracking-[-1.4px] mb-5">
          {region.heading}
        </h3>
      </SlideUp>
      <SlideUp delay={0.2}>
        <p className="font-sans text-white/40 text-[14px] leading-[24px] max-w-[400px] mb-8 text-[#ffffffb8]">
          {region.description}
        </p>
      </SlideUp>
      <SlideUp delay={0.25}>
        <button
          className="inline-flex items-center gap-2 border border-white/10 text-white/80 text-[13px] font-sans font-semibold tracking-[0.39px] px-6 py-3 hover:border-white/30 hover:text-white transition-all cursor-pointer self-start"
        >
          {region.cta}
