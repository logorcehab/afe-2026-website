          ...
          {testimonials.map((t, i) => (
            <SlideUp key={t.name} delay={i * 0.1}>
              ...
              >
                ...
                <p className="text-white/80 text-[15px] font-sans leading-[22px] tracking-[-0.2px] flex-1 transition-colors duration-300 group-hover:text-white/90">
                  "{t.quote}"
                </p>
                <div>
                  <p className="text-white text-[15px] font-sans font-medium">
                    {t.name}
                  </p>
                  <p className="text-white/50 text-[13px] font-sans transition-colors duration-300 group-hover:text-[#e30071]/70">
                    {t.title}
                  </p>
                </div>
              </div>
