...
const imgPhoto1 = "/assets/a1d3fa3396342702ba6d56924fe7d95c81d4ddb2.png";
const imgPhoto2 = "/assets/17bd7d7f3b8306eeb750daff1ad3dd9f1491527f.png";
const imgPhoto3 = "/assets/5e9aaec391017604748c34102a381717922fd947.png";
const imgPhoto4 = "/assets/53a344e9a3892a1a7c6fb749b61132328d9ce7b0.png";
const imgPhoto5 = "/assets/0145ba23a13d45ffeb1144912517c8bf3081df0a.png";
const imgPhoto6 = "/assets/cbfb0d48062a613e9cd0090a001f4737e1b89299.png";
const imgPhoto7 = "/assets/9036c75fee875e798083a536e86e8d00f5fa61c0.png";
const imgPhoto8 = "/assets/61d14ff28b350a182cc5ec6834509ac1105cd26d.png";
const imgPhoto9 = "/assets/d302a5c354f049f4068afb00411bf59158dd2bc2.png";
const imgPhoto10 = "/assets/ea77b2450c2c07ee727e4baa8c42bf03ea958512.png";
const imgPhoto11 = "/assets/ff4729844057b0df8b944b66466a9edae2f65b2c.png";
...
function PhotoCard({ src, idx }: { src: string; idx: number }) {
  return (
    <div className="w-full rounded-lg overflow-hidden shrink-0 h-[280px] relative">
      <Image
        src={src}
    ...
    <section className="bg-[#0e0e1c] py-20 px-6">
      <div className="max-w-[1120px] mx-auto flex flex-col gap-10">
        <div className="flex flex-col gap-2.5 text-center items-center">
          ...
          <h2 className="font-sans font-semibold text-white text-[36px] md:text-[56px] leading-[1.15] tracking-[-3px]">
