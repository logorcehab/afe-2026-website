...
import imgAbout from "figma:asset/8e669bebda42d383b1b57e0a36e6ed077f44a36d.png";
    ...
    <section id="agenda" className="bg-[#0e0e1c] py-20 px-6">
      <div className="max-w-[1120px] mx-auto flex flex-col gap-10">
        <div className="flex flex-col gap-2.5">
          ...
          <SlideUp delay={0.1}>
            <h2 className="font-['Inter',sans-serif] font-semibold text-white text-[46px] md:text-[58px] leading-[1.18] tracking-[-3px]">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          <div className="lg:w-[545px] shrink-0 rounded-lg overflow-hidden relative min-h-[300px]">
            <img src={imgAbout} alt="Africa Financial Week" className="absolute inset-0 w-full h-full object-cover rounded-lg" />
          </div>

          <div className="flex-1 flex flex-col gap-10">
            <div className="flex flex-col gap-1">
              <SlideUp>
                <h3 className="font-['Inter',sans-serif] font-medium text-white text-[22px] tracking-[-0.5px]">
                ...
                {features.map((feat, i) => (
                  <SlideUp key={feat.text} delay={0.05 * (i + 1)}>
                    <div className="flex items-center gap-2.5">
                      ...
                      <span className="text-white/50 text-[15px] font-['Inter',sans-serif] tracking-[-0.2px]">
                        {feat.text}
                      </span>
                    </div>
                  </SlideUp>
