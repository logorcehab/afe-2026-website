import svgPaths from "../../imports/svg-kkfr6lgz0f";
import { SlideUp } from "./SlideUp";
import imgSpeaker1 from "figma:asset/5db0424e5ac75a321e1db479d7f6f8754e9d9375.png";
import imgSpeaker2 from "figma:asset/853f8fd3e27f1c3bfd6ebe8faf7dd58096a3dacc.png";
import imgSpeaker3 from "figma:asset/0b8669bc62fdfdee0d9767030c9896fd0d440f86.png";
import imgSpeaker4 from "figma:asset/754af36fc492883a877d409d4baa1600a54a00d2.png";
import imgSpeaker5 from "figma:asset/406fd059d1c8e41882381ea7b7e4b4a0e9c80736.png";
import imgSpeaker6 from "figma:asset/75ffc67b009066d78f57d70105fa24d3fdcc72de.png";
        ...
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-[10px] items-center lg:items-stretch">
          ...
          <div className="lg:flex-1 flex flex-col justify-between shrink-0 lg:min-h-[480px]">
            <div className="flex flex-col gap-[10px]">
              <SlideUp>
                <span className="text-white text-[15px] font-['Inter',sans-serif] tracking-[-0.2px] leading-[22px]">
                  Speakers
                </span>
              </SlideUp>
              <SlideUp delay={0.1}>
                <h2 className="font-['Inter',sans-serif] font-semibold text-white text-[36px] md:text-[58px] leading-[1.1] md:leading-[68px] tracking-[-2px] md:tracking-[-3px]">
                  Meet the Voices
                  <br />
                  Shaping Africa's
                  <br />
            ...
            <SlideUp delay={0.2}>
              <div className="bg-[#121216] rounded-lg p-5 flex flex-col gap-[19px] max-w-[310px]">
                ...
                <p className="text-white text-[14px] font-['Inter',sans-serif] tracking-[-0.2px] leading-[22px]">
          ...
          <div className="flex-1 flex gap-[5px] h-[250px] lg:h-[900px] overflow-hidden relative">
            ...
            <div className="absolute inset-x-0 top-0 h-[180px] lg:h-full" />
            <div className="absolute inset-x-0 bottom-0 h-[180px] lg:h-full" />
